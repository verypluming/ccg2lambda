...
plain_dir="vid_plain" # tokenized sentences.
parsed_dir="vid_parsed" # parsed sentences into XML or other formats.
results_dir="vid_results" # HTML semantic outputs, proving results, etc.
...
function select_answer() {
  ...
  sentences_basename=${base_fname1/.easyccg/}
  if [ ! -e $answer1_fname ] && [ ! -e $answer2_fname ]; then
    echo "unknown" > ${answer1_fname/.easyccg/};
    prediction_fname=""
    ...
    gold_answer=`cat ${gold_file/.easyccg/}` #gold
